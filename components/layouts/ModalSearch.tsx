...
import {
    Button, Input, InputGroup, InputLeftElement, Modal, ModalContent,
    ModalFooter, ModalHeader, ModalOverlay, Box, useColorModeValue
    ...
    return (
        <>
            <Modal isOpen={openModal} onClose={handleModal}>
                <ModalOverlay />
                <ModalContent backgroundColor={useColorModeValue('gray.100', 'darkness.900')}>
